...
async function fetchTraces(filters: TraceFilters): Promise<TraceSummary[]> {
  ...
  params.set("project_id", filters.projectId || "00000000-0000-0000-0000-000000000001");
 ...
 */
export function useTrace(traceId: string, projectId = "00000000-0000-0000-0000-000000000001") {
  return useQuery({
 ...
 */
export function useTraceSearch(query: string, projectId = "00000000-0000-0000-0000-000000000001") {
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const response = await fetch(
        `${API_BASE}/api/traces/search?${params}`
      );
      if (!response.ok) {
...
export function useTraceCount(
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const response = await fetch(
        `${API_BASE}/api/traces/count?${params}`
      );
      if (!response.ok) {
