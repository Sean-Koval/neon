...
const CORRECTION_TYPES = [
  { id: 'factual', label: 'Factual Error', color: 'bg-rose-100 text-rose-700' },
  {
    id: 'incomplete',
    label: 'Incomplete',
    color: 'bg-amber-100 text-amber-700',
  },
  { id: 'tone', label: 'Tone/Style', color: 'bg-blue-100 text-blue-700' },
  { id: 'clarity', label: 'Clarity', color: 'bg-purple-100 text-purple-700' },
  {
    id: 'relevance',
    label: 'Relevance',
    color: 'bg-emerald-100 text-emerald-700',
  },
  { id: 'formatting', label: 'Formatting', color: 'bg-gray-100 text-gray-700' },
] as const
  ...
  return (
    <div className="text-xs text-gray-500 flex items-center gap-4">
      <span>
        ...
        <span
          className={clsx(
            charDiff > 0 && 'text-emerald-600',
            charDiff < 0 && 'text-rose-600',
          )}
        >
          {charDiff > 0 ? '+' : ''}
          {charDiff}
      ...
      <span>
        ...
        <span
          className={clsx(
            wordDiff > 0 && 'text-emerald-600',
            wordDiff < 0 && 'text-rose-600',
          )}
        >
          {wordDiff > 0 ? '+' : ''}
          {wordDiff}
    ...
    <div className="space-y-6">
      ...
      {prompt && (
        <div className="card p-4 bg-gray-50">
          ...
          <p className="mt-2 text-gray-900 text-sm">{prompt}</p>
        </div>
      )}
      ...
      <div className="space-y-2">
        ...
        <textarea
          ...
          className={clsx(
            'w-full px-4 py-3 border rounded-lg text-sm font-mono focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-colors',
            hasChanges
      ...
      <div className="flex items-center justify-between pt-4 border-t border-gray-200">
        <button
          ...
          className="flex items-center gap-2 px-3 py-2 text-sm text-gray-600 hover:text-gray-800 disabled:opacity-30 disabled:cursor-not-allowed"
        >
