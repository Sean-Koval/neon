...
import { ChevronRight, ChevronDown, Clock, Zap, MessageSquare, Wrench, Database } from "lucide-react";
      ...
      >
        ...
        <div
          className={cn(
            ...
            span.status === "error" ? "bg-red-500" : getSpanColor(span.span_type)
          )}
        />
      ...
      <div className="flex-1 relative h-10 bg-gray-50">
        <div
          className={cn(
            ...
            span.status === "error" ? "bg-red-400" : getSpanColor(span.span_type),
            "opacity-80"
          )}
          style={{
            left: `${offsetPercent}%`,
