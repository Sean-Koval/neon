...
export function StatisticalGuidance() {
  ...
  return (
    <div className="border border-gray-200 rounded-lg bg-white">
      ...
      {isExpanded && (
        <div className="px-4 pb-4 space-y-4 text-sm text-gray-600 border-t border-gray-100 pt-3">
          <div>
            <h4 className="font-medium text-gray-900 mb-1">Score Interpretation</h4>
            <p>
          ...
          <div>
            <h4 className="font-medium text-gray-900 mb-1">Pass Rate</h4>
            <p>
          ...
          <div>
            <h4 className="font-medium text-gray-900 mb-1">Regression Detection</h4>
            <p>
          ...
          <div>
            <h4 className="font-medium text-gray-900 mb-1">Score Trends</h4>
            <p>
